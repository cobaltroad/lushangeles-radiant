...
# Fixing 'unitialized constant ActiveSupport::Dependencies::Mutex (Name Error)'
require 'thread'
...
Radiant::Initializer.run do |config|
  ...
  config.action_controller.session = {
    :key => '_lushangeles_session',
    :secret      => 'e57f52af46f8c9a7112335a27b5ea7657d51739e'
  }
  ...
  # By default, Radiant caches CMS pages in RAILS_ROOT/cache.  This won't work with Heroku's
  # read-only file system, so change it to cache files in the tmp directory. 
